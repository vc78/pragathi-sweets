...
public class EmailTemplateService {
    ...
    private String renderOrderEmail(OrderEmailData data, String title, String introMessage, String statusBadge, String badgeColor, boolean isConfirmation) {
        ...
        String supportPhone = data.getSupportPhone() != null ? data.getSupportPhone() : "+91 98490 12345";
    ...
    private String renderOrderPlainText(OrderEmailData data, String header, String introMessage) {
        ...
        sb.append("Support: Email ").append(data.getSupportEmail() != null ? data.getSupportEmail() : "support@pragathisweets.com")
                .append(" or Phone ").append(data.getSupportPhone() != null ? data.getSupportPhone() : "+91 98490 12345").append("\n");
