...
export default function WhatsAppConfirmationModal({ isOpen, onClose, order, customerName, defaultPhone }) {
  ...
  const buildFallbackMessage = () => {
    ...
    msg += `📞 Need help? Call/WhatsApp us at ${BUSINESS?.contact?.phone || '+91 98765 43210'}\n`
    msg += `🌐 pragathisweets.com\n\n`
            ...
            <div className="flex items-center gap-3">
              ...
              <div>
                <div className="flex items-center gap-1.5">
                  <h3 className="font-semibold text-sm tracking-wide">Pragathi Sweets Dispatch</h3>
